...
- Mọi corner F2L chưa giải đều có thể được nhấp chọn mà không làm xoay khối, kể cả corner bị xoắn ngay đúng slot; corner được viền cam nổi bật, đồng thời edge cùng cặp F2L (theo màu gốc của corner) được viền xanh dương để người dùng dễ xác định cạnh còn thiếu. Khi chọn, đánh dấu `X` màu hồng trực tiếp trên các sticker màu cạnh của cặp: cả hai màu chung không-trắng/không-vàng của corner, và sticker tương ứng trên edge (ví dụ: cặp xanh lá–cam–trắng được đánh dấu trên sticker xanh lá và cam của corner, cùng sticker xanh lá hoặc cam của edge). Không đánh dấu sticker trắng/vàng. Dấu `X` thường có màu xám `#9CA3AF`, nhưng sticker cam của cặp được chọn dùng dấu `X` đỏ `#E11D48` để dễ nhận biết; nét cọ mảnh và hơi không đều như được vẽ bằng tay, thay vì hai đường thẳng hình học. Dấu `X` được hiển thị xuyên qua khối để tất cả sticker của cặp được chọn luôn có thể nhận biết, kể cả sticker/cubie đang khuất khỏi camera. Trạng thái cho biết cặp đang được chọn.
